...
def start():
    ...
    scheduler.add_job(tasks.update_items,args=['new'],trigger="interval",minutes=10,id="FetchNewTaskid",replace_existing=True,misfire_grace_time=None,next_run_time=now)# add task to backgroud scheduler and run at intervals
